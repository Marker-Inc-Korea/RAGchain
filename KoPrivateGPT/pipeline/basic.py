...
class BasicIngestPipeline(BasePipeline, BaseModel):
    file_loader_type: tuple[str, Dict[Any]] = ("file_loader", {"target_dir": Options.source_dir}),
    text_splitter_type: tuple[str, Dict[Any]] = ("recursive_text_splitter", {"chunk_size": 500, "chunk_overlap": 50}),
    db_type: tuple[str, Dict[Any]] = ("pickle_db", {"save_path": DBOptions.save_path}),
    retrieval_type: tuple[str, Dict[Any]] = ("vector_db", {"vectordb_type": "chroma",

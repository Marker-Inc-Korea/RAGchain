...
def beir_hotpotqa_evaluator():
    ...
    evaluator = BeirHotpotQAEvaluator(pipeline, evaluate_size=5)
...
def test_beir_hotpotqa_evaluator(beir_hotpotqa_evaluator):
    result = beir_hotpotqa_evaluator.evaluate()

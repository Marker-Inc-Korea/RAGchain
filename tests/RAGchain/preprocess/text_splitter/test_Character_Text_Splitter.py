...
from RAGchain.preprocess.text_splitter import CharacterSplitter
...
def character_text_splitter():
    ...
    yield character_splitter


# 왜


def test_character_text_splitter(character_splitter):
    passages = character_splitter.split_document(TEST_DOCUMENT)

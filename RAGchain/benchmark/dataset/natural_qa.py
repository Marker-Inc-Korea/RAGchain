...
class NATURALQAEvaluator(BaseDatasetEvaluator):
    ...
    def __init__(self, run_pipeline: BaseRunPipeline,
        ...
        Notice:
        Raw natural qa dataset is too large, so we use natural questions short qa by lucadiliello in huggingface.
        """
        ...
        self.qa_data = self.dataset.to_pandas()
